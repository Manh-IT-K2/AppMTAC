...
class Kernel extends HttpKernel
{
     ...
     *
     * This value is used by the router to determine which middleware
     * to execute during every request to your application.
     *
     * @var array
     */
    ...
    protected $routeMiddleware = [
        ...
        'disable_api_csrf' => \App\Http\Middleware\DisableApiCsrf::class,
